                      ...
                      <?php foreach ($ordersAirport->list as $order):?>
                        <tr>
                            ...
                            <td class="align-middle text-center text-sm">
                              <span class="text-secondary text-xs font-weight-bold"><?=$order->telefone?></span>
                            </td>
                            <td class="align-middle text-center">
                              <span class=" badge badge-sm bg-gradient-success"><?=$order->service_type?></span>
                            </td>
                            <td class="align-middle">
                              <a href='<?=$base?>/edit/<?=$order->id?>/<?=$order->service_type?>' class='btn bg-gradient-info btn-sm '>Ver Mais</a>
                              <a href='<?=$base?>/excluir/<?=$order->id?>/<?=$order->service_type?>' onclick='confirm("Tem certeza que deseja excluir o pedido!!")' class='btn bg-gradient-danger btn-sm ms-3'>Excluir</a>
                            </td>
                        </tr>
                      <?php endforeach;?>
                    <?php endif;?>
                    ...
                    <?php if(!empty($ordersLimousine)):?>
                      <?php foreach ($ordersLimousine->list as $order):?>
                        <tr>
                            ...
                            <td class="align-middle text-center text-sm">
                              <span class="text-secondary text-xs font-weight-bold"><?=$order->phone?></span>
                            </td>
                            <td class="align-middle text-center">
                              <span class=" badge badge-sm bg-gradient-success"><?=$order->service_type?></span>
                            </td>
