<div class="col-lg-7 mb-lg-0 mb-4 col-sm-9">
    ...
    <form action="<?=$base?>/edit" method="post">
        ...
        <div class="mb-3">
            ...
            <input class='form-control' type="text" name='name' value='<?=$order->name_user?>'>
        </div>
        ...
        <div class="mb-3">
            ...
            <input class='form-control' type="text" name='phone' value='<?=$order->telefone?>'>
        </div>
        ...
        <div class="mb-3">
            ...
            <input class='form-control' type="text"name='conection' value='<?=$order->service_type?>'>
        </div>
        ...
        <a onclick="confirm('Tem certeza que deseja excluir o pedido?')" class="btn btn-danger btn-lg" href="<?=$base?>/excluir/<?=$order->id?>">Excluir</a>
    </form>
    </div>
</div>
</div>